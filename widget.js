...
(function(){
    ...
    script0.src = domain + "/static/js/main.6e7178ef.chunk.js";
    document.body.append(script0);

    var script1 = document.createElement('script');
    script1.src = domain + "/static/js/1.8db1b4ac.chunk.js";
    document.body.append(script1);

    var script2 = document.createElement('script');
    script2.src = domain + "/static/js/2.fba6d919.chunk.js";
    document.body.append(script2);

    // Include styles
    var style0 = document.createElement('link');
    style0.rel = "stylesheet";
    style0.href = domain + "/static/css/main.16019c82.chunk.css";
